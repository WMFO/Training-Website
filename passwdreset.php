  ...
  if($result->num_rows) {
    ...
    if ($stmt != false) {
      ...
      if ($stmt->affected_rows == 1) {
        ...
        $message = "Hello Freeformer!\n\nYou're receiving this email because someone requested a password change on your WMFO TEMS (Training Education Management System) Account. If that was you, fantastic! Click the link below to load the apssword reset page:\n\nhttps://" . $_SERVER['SERVER_NAME'] . "/passwdreset.php?key=" . $secret . "\n\nHowever, if this was not you, simply ignore this email. The reset code will expire on it's own after 60 minutes.";
